...
from .subsystems.backlight import handle_request_response_backlight
...
def handle_request_response(request_response: studio.RequestResponse):
    ...
    if req_response_subsystem == "backlight":
        handle_request_response_backlight(request_response.backlight)

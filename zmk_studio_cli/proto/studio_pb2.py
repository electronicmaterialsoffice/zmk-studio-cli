...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_REQUESTRESPONSE']._serialized_start=437
  _globals['_REQUESTRESPONSE']._serialized_end=691
  _globals['_NOTIFICATION']._serialized_start=693
